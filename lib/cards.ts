...
export const CARDS: Card[] = [
  {
    ...
    body: 'Tato karta ztělesňuje kvalitu změny, uvádí nás do pohybu. Je třeba udělat místo pro nové možnosti růstu, abychom přinesli do života něco nového. Vše co je strnulé a brzdí nás je potřeba uvolnit. Opustit paradigma a vykročit na novou cestu, neboť změna je kořením života. Přijměte zasvěcení bleskem a zchlazení vodou pokorně a bez hodnocení.',
  ...
  },
  {
    ...
    body: 'Disciplína přirozeně formuje a zpevňuje naši osobnost, vyrovnává vnitřní a vnější tlak způsobený procesem růstu. Vytváří pružný obal neboli ochranu, která nebrání růstu, ale kultivuje. Usměrňuje osobní víru pro zvládnutí jakékoli životní zkoušky.',
  ...
  },
  {
    ...
    body: 'Schopnost vyladění se na pocity srdce. Vcítění naslouchá emocím. Učíme se rozlišovat, co je pro nás příjemné a nepříjemné. Sounáležitost harmonizuje myšlenkové pochody mezi myslí asrdcem. Vyrovnáním nacházíme napojení, pocity, sny a vize. Objasňující vše, co je pro vás důležité.',
  ...
  },
  {
    ...
    body: 'Lpěním na identitě vyživujeme Ego. Opusťme tedy hodnocení sebe sama a pomyslně překročme osobní hranice a spatříme pravé Já. Překonáním těchto pomyslných hranic se otevírají nové pohledy na život. Záblesk osvícení rozšiřuje vědomí a tím prohlubuje zkušenost prožitku pravého Já. Kapitulace Ega.',
  ...
  },
  {
    ...
    body: 'Uvolni paradigma starého světa, otevři se novým možnostem. Zanechej strnulost dávných věků, přivítej nové poznání. Jsme novátoři, průzkumníci nových světů, objevitelé nepoznaného.',
...
export const getCardBySlug = (slug: string): Card | undefined => {
